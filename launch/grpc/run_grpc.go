...
import (
	...
	defgrpc "toys/infrastructure/util/def/grpc"
	"toys/infrastructure/util/logging"
	"toys/interfaces/proto"
	"toys/interfaces/proto/facade"
	middleware2 "toys/launch/grpc/middleware"
)
...
func RunGrpc() {
	...
	proto.RegisterToysServer(grpcServer, &facade.Toys{})
...
func registerService() {
	serviceInstance := consul.NewServiceInstance(strconv.FormatInt(time.Now().Unix(), 10), "toys", "grpc", "docker.for.mac.host.internal", 8082, false, map[string]string{})
